...
public partial class GameEntity {
    ...
    public Code.Ecs.Components.IdComponent id { get { return (Code.Ecs.Components.IdComponent)GetComponent(GameComponentsLookup.Id); } }
    ...
    public void AddId(int newValue) {
        ...
        var component = (Code.Ecs.Components.IdComponent)CreateComponent(index, typeof(Code.Ecs.Components.IdComponent));
