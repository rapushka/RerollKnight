...
public partial class GameEntity {
    ...
    public Code.Ecs.Components.ViewControllerComponent viewController { get { return (Code.Ecs.Components.ViewControllerComponent)GetComponent(GameComponentsLookup.ViewController); } }
    public bool hasViewController { get { return HasComponent(GameComponentsLookup.ViewController); } }

    public void AddViewController(Code.Unity.Views.ViewController.IViewController newValue) {
        var index = GameComponentsLookup.ViewController;
        var component = (Code.Ecs.Components.ViewControllerComponent)CreateComponent(index, typeof(Code.Ecs.Components.ViewControllerComponent));
        component.Value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceViewController(Code.Unity.Views.ViewController.IViewController newValue) {
        var index = GameComponentsLookup.ViewController;
        var component = (Code.Ecs.Components.ViewControllerComponent)CreateComponent(index, typeof(Code.Ecs.Components.ViewControllerComponent));
        component.Value = newValue;
