...
public sealed class DestroySpawnPlayerRequestSystem : ICleanupSystem {

    readonly IGroup<RequestEntity> _group;
    readonly List<RequestEntity> _buffer = new List<RequestEntity>();

    public DestroySpawnPlayerRequestSystem(Contexts contexts) {
        _group = contexts.request.GetGroup(RequestMatcher.SpawnPlayer);
    }
