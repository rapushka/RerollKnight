...
public sealed class DestroyDropRequestSystem : ICleanupSystem {

    readonly IGroup<RequestEntity> _group;
    readonly List<RequestEntity> _buffer = new List<RequestEntity>();

    public DestroyDropRequestSystem(Contexts contexts) {
        _group = contexts.request.GetGroup(RequestMatcher.Drop);
    }
