...
public partial class GameEntity {
    ...
    public Code.HealthComponent health { get { return (Code.HealthComponent)GetComponent(GameComponentsLookup.Health); } }
    ...
    public void AddHealth(int newValue) {
        ...
        var component = (Code.HealthComponent)CreateComponent(index, typeof(Code.HealthComponent));
