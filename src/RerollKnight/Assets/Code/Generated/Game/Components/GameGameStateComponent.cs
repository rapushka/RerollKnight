...
public partial class GameContext {
    ...
    public Code.GameStateComponent gameState { get { return gameStateEntity.gameState; } }
    public bool hasGameState { get { return gameStateEntity != null; } }

    public GameEntity SetGameState(Code.GameState newValue) {
        if (hasGameState) {
            throw new Entitas.EntitasException("Could not set GameState!\n" + this + " already has an entity with Code.GameStateComponent!",
    ...
    public void ReplaceGameState(Code.GameState newValue) {
...
public partial class GameEntity {
    ...
    public Code.GameStateComponent gameState { get { return (Code.GameStateComponent)GetComponent(GameComponentsLookup.GameState); } }
    public bool hasGameState { get { return HasComponent(GameComponentsLookup.GameState); } }

    public void AddGameState(Code.GameState newValue) {
        var index = GameComponentsLookup.GameState;
        var component = (Code.GameStateComponent)CreateComponent(index, typeof(Code.GameStateComponent));
