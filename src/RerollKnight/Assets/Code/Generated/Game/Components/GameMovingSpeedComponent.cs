...
public partial class GameEntity {
    ...
    public Code.MovingSpeedComponent movingSpeed { get { return (Code.MovingSpeedComponent)GetComponent(GameComponentsLookup.MovingSpeed); } }
    ...
    public void AddMovingSpeed(float newValue) {
        ...
        var component = (Code.MovingSpeedComponent)CreateComponent(index, typeof(Code.MovingSpeedComponent));
